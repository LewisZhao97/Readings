...
> If you are working with TouchDesigner, all you will need for this tutorial is a single GLSL TOP. In the “Common” tab, I changed the “Output Resolution” parameter from “Use Input” to “Custom Resolution,” `720 x 720`.

![](https://michaelwalczyk.com/assets/img/blog/ray-marching/complete-shader.gif)
...
![](https://michaelwalczyk.com/assets/img/blog/ray-marching/circle-distance.png)
...
> If you are familiar with **ray tracing**, you might wonder why we can’t just directly compute the point of intersection between our ray and our sphere. For this simple scene, we actually could do this! However, as we will see towards the end of this tutorial, the real power of ray marching lies in its ability to render shapes where this exact point of intersection is not as obvious.
...
![](https://michaelwalczyk.com/assets/img/blog/ray-marching/sphere-tracing.png)
...
> If you are following along with this tutorial and not using TouchDesigner, the specifics of where your UV-coordinates come from will be implementation defined. Regardless of what framework / toolkit you’re using, you just need to be able to draw a full-screen quad and calculate UV-coordinates, either by normalizing the built-in variable `gl_FragCoord.xy`, or otherwise. Also, if you are rendering an image that is not square, you will need to take into account your aspect ratio when deriving your UV-coordinates. For now, I’ll leave this as an exercise…
...
![](https://michaelwalczyk.com/assets/img/blog/ray-marching/image-plane.png)
...
![](https://michaelwalczyk.com/assets/img/blog/ray-marching/sphere-normals.png)
...
![](https://michaelwalczyk.com/assets/img/blog/ray-marching/sphere-shaded.png)

## Distorting the Distance Function

Now, for the cool part! Once we have a basic ray marching setup, we can “nudge” or perturb our distance functions to create more interesting shapes. For example, we can add a sinusoidal distortion to our sphere’s SDF by modifying the map\_the\_world function like so:
...
![](https://michaelwalczyk.com/assets/img/blog/ray-marching/sphere-distorted.png)
